...
internal class SQLBuilderTest {
    ...
    fun testMock() {
        ...
        val rsCount1 = MockSQLBuilderProvider.invocations.next
        sb11.getList(mockConnection) { rs -> rs.getLong("USER_ID") }.toString() shouldBe "[100000, 100001, 100002, 100003]"
        val rsCount2 = MockSQLBuilderProvider.invocations.next
    ...
    fun reuseResultSetData1() {
        ...
        MockSQLBuilderProvider.invocations.next shouldBe 4
    }
    ...
    fun reuseResultSetData2() {
        ...
        MockSQLBuilderProvider.invocations.next shouldBe 2
    }
    ...
    fun reuseResultSetData4() {
        ...
        MockSQLBuilderProvider.invocations.next shouldBe 7
    }
    ...
    fun invocation_test1() {
        ...
        MockSQLBuilderProvider.invocations.next shouldBe 3
        ...
        MockSQLBuilderProvider.invocations.next shouldBe 6
    }
