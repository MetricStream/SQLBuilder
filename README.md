...
[com.metricstream.jdbc:sqlbuilder-core:3.4.0](https://search.maven.org/artifact/com.metricstream.jdbc/sqlbuilder-core/3.4.0/jar)
for production usage and
[com.metricstream.jdbc:sqlbuilder-mock:3.4.0](https://search.maven.org/artifact/com.metricstream.jdbc/sqlbuilder-mock/3.4.0/jar)
for unit testing.
